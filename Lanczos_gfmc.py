...
res_lower = korr.final_res_lower[0] / (n_skip * dtau)
res_lower_err = korr.final_res_lower_err[0] / (n_skip * dtau)
res_upper = korr.final_res_upper[0] / (n_skip * dtau)
res_upper_err = korr.final_res_upper_err[0] / (n_skip * dtau)
print("\nFinal E = ", final_E, " +/- ", final_E_err)
print("Final <H> = ", med_H[-1], " +/- ", med_H_err[-1])
print("\nResidual upper bound = ", res_upper, " +/- ", res_upper_err)
print("Residual lower bound = ", res_lower, " +/- ", res_lower_err)
print("\n")
