...
with open(database[:-2]+'csv', 'w', newline='') as csvfile:
    ...
    writer.writeheader()
    writer.writerow({'mean_samp': sam_mean.tolist(),'err_samp': sam_err.tolist(),'mean_fit': model_averaged_fit, 'err_fit': model_averaged_err, 'chi2dof': model_averaged_redchisq})
