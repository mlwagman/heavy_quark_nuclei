...
if __name__ == '__main__':
    ...
    filename = output + "exp" + str(N_exp) + "_Ncoord" + str(N_coord) + "_cutoff" + str(cutoff) + "_order" + str(OLO) + "_alpha" + str(alpha) + f"_potential{VB:.3f}.wvfn"
    ...
    filenamec = "exp" + str(N_exp) + "_Ncoord" + str(N_coord) + "_cutoff" + str(cutoff) + "_order" + str(OLO) + "_alpha" + str(alpha)
