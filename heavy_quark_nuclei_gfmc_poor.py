...
with h5py.File('Hammys_poor_'+"N_coord="+str(N_coord)+"_B="+str(VB)+"_nStep="+str(n_step)+"_dtau="+str(dtau_iMev)+"_a0="+str(a0)+'.hdf5', 'w') as f:
    dset = f.create_dataset("Hammys", data=Ks+Vs)

with h5py.File('Rs_poor_'+"N_coord="+str(N_coord)+"_B="+str(VB)+"_nStep="+str(n_step)+"_dtau="+str(dtau_iMev)+"_a0="+str(a0)+'.hdf5', 'w') as f:
    dset = f.create_dataset("Rs", data=gfmc_Rs)

with h5py.File('Hammys_poor_'+"N_coord="+str(N_coord)+"_B="+str(VB)+"_nStep="+str(n_step)+"_dtau="+str(dtau_iMev)+"_a0="+str(a0)+'.hdf5', 'r') as f:
    data = f['Hammys']
    print(data)

with h5py.File('Rs_poor_'+"N_coord="+str(N_coord)+"_B="+str(VB)+"_nStep="+str(n_step)+"_dtau="+str(dtau_iMev)+"_a0="+str(a0)+'.hdf5', 'r') as f:
    data = f['Rs']
    print(data)
...
plt.savefig('Hammys_poor_'+"N_coord="+str(N_coord)+"_B="+str(VB)+"_nStep="+str(n_step)+"_dtau="+str(dtau_iMev)+"_a0="+str(a0)+'.pdf')
