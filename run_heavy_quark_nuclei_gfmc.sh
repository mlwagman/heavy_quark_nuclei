...
VB=1.18
a0=1.694
mpirun -np 1 python3 heavy_quark_nuclei_gfmc.py --dtau_iMev=$dtau --n_step $n_step --n_walkers $n_walkers --N_coord $N_coord --VB $VB --a0 $a0 > gfmc_log_dtau${dtau}_nstep${n_step}_Ncoord${N_coord}_VB${VB}_a0${a0} &
